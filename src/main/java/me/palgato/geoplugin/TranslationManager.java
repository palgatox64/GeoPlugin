...
public final class TranslationManager {
    ...
    public String tr(String key, Object... args) {
        ...
        String template = switch (key) {
            ...
            case "cmd.top_countries_connections" -> select("Top Countries by Total Connections:", "Top países por conexiones totales:");
            case "cmd.top_countries_unique" -> select("Top Countries by Unique Players:", "Top países por jugadores únicos:");
